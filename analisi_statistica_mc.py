...
with open('accuratezza_modelli_cv_mc.pkl', 'rb') as file:
...
with open('accuratezza_modelli_ncs_mc.pkl','rb') as file:
    accuratezza_modelli_ncs_mc = pickle.load(file)

accuratezza_model_ncs = np.array(accuratezza_modelli_ncs_mc)
accuratezza_model_ncs = accuratezza_model_ncs[0]


with open('accuratezza_modelli_ncs_mc1.pkl', 'rb') as file:
    accuratezza_modelli_ncs_mc1 = pickle.load(file)

accuratezza_model_ncs1 = np.array(accuratezza_modelli_ncs_mc1)
accuratezza_model_ncs1 = accuratezza_model_ncs1[0]


accuratezza_modelli_ncs = np.concatenate((accuratezza_model_ncs, accuratezza_model_ncs1),axis = 1)



with open('Accuratezza_modelli_cs_cv_mc.pkl','rb') as file:
    accuratezza_modelli_cs_cv_mc = pickle.load(file)

accuratezza_modelli_cs_cv = np.array(accuratezza_modelli_cs_cv_mc)
accuratezza_modelli_cs_cv = accuratezza_modelli_cs_cv[0]



with open('accuratezza_modelli_cs_mc.pkl','rb') as file:
...
print("ncs",np.mean(accuratezza_modelli_ncs[0]),np.mean(accuratezza_modelli_ncs[1]),np.mean(accuratezza_modelli_ncs[2]),np.mean(accuratezza_modelli_ncs[3]),np.mean(accuratezza_modelli_ncs[4]))
print("cv",np.mean(accuratezza_modelli_cvs[0]),np.mean(accuratezza_modelli_cvs[1]),np.mean(accuratezza_modelli_cvs[2]),np.mean(accuratezza_modelli_cvs[3]),np.mean(accuratezza_modelli_cvs[4]))
print("cs_cv",np.mean(accuratezza_modelli_cs_cv[0]),np.mean(accuratezza_modelli_cs_cv[1]),np.mean(accuratezza_modelli_cs_cv[2]),np.mean(accuratezza_modelli_cs_cv[3]),np.mean(accuratezza_modelli_cs_cv[4]))
print("cs",np.mean(accuratezza_modelli_cs[0]),np.mean(accuratezza_modelli_cs[1]),np.mean(accuratezza_modelli_cs[2]),np.mean(accuratezza_modelli_cs[3]),np.mean(accuratezza_modelli_cs[4]))
...
stats.probplot(accuratezza_modelli_cs_cv[0], dist='norm', plot=axes[0])
axes[0].set_title('QQ-plot-CV_CS ACCURATEZZA')
axes[0].set_ylabel('KNN')

stats.probplot(accuratezza_modelli_cs_cv[1], dist='norm', plot=axes[1])
axes[1].set_ylabel('SVM')

stats.probplot(accuratezza_modelli_cs_cv[2], dist='norm', plot=axes[2])
axes[2].set_ylabel('RF')

stats.probplot(accuratezza_modelli_cs_cv[3], dist='norm', plot=axes[3])
axes[3].set_ylabel('AB')

stats.probplot(accuratezza_modelli_cs_cv[4], dist='norm', plot=axes[4])
axes[4].set_ylabel('MLP')
...
axes[0].hist(accuratezza_modelli_cs_cv[0], bins = 10)
axes[0].set_title('ISTOGRAMMA CV-CS ACCURATEZZA')
axes[0].set_ylabel('KNN')

axes[1].hist(accuratezza_modelli_cs_cv[1], bins = 10)
axes[1].set_ylabel('SVM')

axes[2].hist(accuratezza_modelli_cs_cv[2], bins = 10)
axes[2].set_ylabel('RF')

axes[3].hist(accuratezza_modelli_cs_cv[3], bins = 10)
axes[3].set_ylabel('AB')

axes[4].hist(accuratezza_modelli_cs_cv[4], bins = 10)
axes[4].set_ylabel('MLP')
...
axes[0].boxplot(accuratezza_modelli_cs_cv[0])
axes[0].set_title('ISTOGRAMMA CV-CS ACCURATEZZA')
axes[0].set_ylabel('KNN')

axes[1].boxplot(accuratezza_modelli_cs_cv[1])
axes[1].set_ylabel('SVM')

axes[2].boxplot(accuratezza_modelli_cs_cv[2])
axes[2].set_ylabel('RF')

axes[3].boxplot(accuratezza_modelli_cs_cv[3])
axes[3].set_ylabel('AB')

axes[4].boxplot(accuratezza_modelli_cs_cv[4])
axes[4].set_ylabel('MLP')
...
for i in range(5):
    ...
    d2 = {"Accuratezza":accuratezza_modelli_cs_cv[i]}
    descr1 = "Modello CV"
...
for i in range(5):
    [dist_norm, p_value] = stats.kstest(accuratezza_modelli_cs_cv[i], 'norm')
    if p_value < 0.05:
        print(f"rifiuto l'ipotesi nulla per {modelli[i]}",p_value)
    elif p_value > 0.05:
        print(f"accetto l'ipotesi per {modelli[i]}",p_value)
...
for i in range(5):
    [dist_norm, p_value] = stats.shapiro(accuratezza_modelli_cs_cv[i])
    if p_value < 0.05:
        print(f"rifiuto l'ipotesi nulla per {modelli[i]}",p_value)
    elif p_value > 0.05:
        print(f"accetto l'ipotesi per {modelli[i]}",p_value)
...
for alt in alternative:
    [stats_knn, p_value_knn] = stats.mannwhitneyu(accuratezza_modelli_cvs[0],accuratezza_modelli_cs_cv[0],alternative=alt)
    [stats_svm, p_value_svm] = stats.mannwhitneyu(accuratezza_modelli_cvs[1],accuratezza_modelli_cs_cv[1],alternative=alt)
    [stats_rf, p_value_rf] = stats.mannwhitneyu(accuratezza_modelli_cvs[2],accuratezza_modelli_cs_cv[2],alternative=alt)
    [stats_ab, p_value_ab] = stats.mannwhitneyu(accuratezza_modelli_cvs[3],accuratezza_modelli_cs_cv[3],alternative=alt)
    [stats_mlp, p_value_mlp] = stats.mannwhitneyu(accuratezza_modelli_cvs[4],accuratezza_modelli_cs_cv[4],alternative=alt)
...
for alt in alternative:
    [stats_knn, p_value_knn] = stats.mannwhitneyu(accuratezza_modelli_ncs[0],accuratezza_modelli_cs_cv[0],alternative=alt)
    [stats_svm, p_value_svm] = stats.mannwhitneyu(accuratezza_modelli_ncs[1],accuratezza_modelli_cs_cv[1],alternative=alt)
    [stats_rf, p_value_rf] = stats.mannwhitneyu(accuratezza_modelli_ncs[2],accuratezza_modelli_cs_cv[2],alternative=alt)
    [stats_ab, p_value_ab] = stats.mannwhitneyu(accuratezza_modelli_ncs[3],accuratezza_modelli_cs_cv[3],alternative=alt)
    [stats_mlp, p_value_mlp] = stats.mannwhitneyu(accuratezza_modelli_ncs[4],accuratezza_modelli_cs_cv[4],alternative=alt)
...
for alt in alternative:
    [stats_knn, p_value_knn] = stats.ttest_ind(accuratezza_modelli_ncs[0],accuratezza_modelli_cvs[0], alternative=alt)
    [stats_svm, p_value_svm] = stats.ttest_ind(accuratezza_modelli_ncs[1],accuratezza_modelli_cvs[1], alternative=alt)
    [stats_rf, p_value_rf] = stats.ttest_ind(accuratezza_modelli_ncs[2],accuratezza_modelli_cvs[2], alternative=alt)
    [stats_ab, p_value_ab] = stats.ttest_ind(accuratezza_modelli_ncs[3],accuratezza_modelli_cvs[3], alternative=alt)
    [stats_mlp, p_value_mlp] = stats.ttest_ind(accuratezza_modelli_ncs[4],accuratezza_modelli_cvs[4], alternative = alt)
    ...
    for i in range(len(lista_p_value)):
        if lista_p_value[i] < alpha:
            print(f"Test T, rifiuto H0 {modelli[i]}",lista_p_value[i],alt)
        else:
            print(f"Test T, accetto H0 {modelli[i]}",lista_p_value[i],alt)



[stats_knn, p_value_knn] = stats.levene(accuratezza_modelli_cvs[0],accuratezza_modelli_cs_cv[0])
[stats_svm, p_value_svm] = stats.levene(accuratezza_modelli_cvs[1],accuratezza_modelli_cs_cv[1])
[stats_rf, p_value_rf] = stats.levene(accuratezza_modelli_cvs[2],accuratezza_modelli_cs_cv[2])
[stats_ab, p_value_ab] = stats.levene(accuratezza_modelli_cvs[3],accuratezza_modelli_cs_cv[3])
[stats_mlp, p_value_mlp] = stats.levene(accuratezza_modelli_cvs[4],accuratezza_modelli_cs_cv[4])
...
for alt in alternative:
    [stats_knn, p_value_knn] = stats.ttest_ind(accuratezza_modelli_cvs[0],accuratezza_modelli_cs_cv[0], alternative = alt)
    [stats_svm, p_value_svm] = stats.ttest_ind(accuratezza_modelli_cvs[1],accuratezza_modelli_cs_cv[1], alternative = alt)
    [stats_rf, p_value_rf] = stats.ttest_ind(accuratezza_modelli_cvs[2],accuratezza_modelli_cs_cv[2], alternative = alt)
    [stats_ab, p_value_ab] = stats.ttest_ind(accuratezza_modelli_cvs[3],accuratezza_modelli_cs_cv[3], alternative = alt)
    [stats_mlp, p_value_mlp] = stats.ttest_ind(accuratezza_modelli_cvs[4],accuratezza_modelli_cs_cv[4], alternative = alt)
...
[stats_svm, p_value_svm] = stats.levene(accuratezza_modelli_ncs[1],accuratezza_modelli_cs[1])
[stats_rf, p_value_rf] = stats.levene(accuratezza_modelli_ncs[2],accuratezza_modelli_cs[2])
[stats_ab, p_value_ab] = stats.levene(accuratezza_modelli_ncs[3],accuratezza_modelli_cs[3])
[stats_mlp, p_value_mlp] = stats.levene(accuratezza_modelli_ncs[4],accuratezza_modelli_cs[4])
...
for alt in alternative:
    ...
    [stats_svm, p_value_svm] = stats.ttest_ind(accuratezza_modelli_ncs[1],accuratezza_modelli_cs[1], alternative=alt)
    [stats_rf, p_value_rf] = stats.ttest_ind(accuratezza_modelli_ncs[2],accuratezza_modelli_cs[2], alternative=alt)
    [stats_ab, p_value_ab] = stats.ttest_ind(accuratezza_modelli_ncs[3],accuratezza_modelli_cs[3], alternative=alt)
    [stats_mlp, p_value_mlp] = stats.ttest_ind(accuratezza_modelli_ncs[4],accuratezza_modelli_cs[4], alternative = alt)
...
[stats_knn, p_value_knn] = stats.levene(accuratezza_modelli_ncs[0],accuratezza_modelli_cs_cv[0])
[stats_svm, p_value_svm] = stats.levene(accuratezza_modelli_ncs[1],accuratezza_modelli_cs_cv[1])
[stats_rf, p_value_rf] = stats.levene(accuratezza_modelli_ncs[2],accuratezza_modelli_cs_cv[2])
[stats_ab, p_value_ab] = stats.levene(accuratezza_modelli_ncs[3],accuratezza_modelli_cs_cv[3])
[stats_mlp, p_value_mlp] = stats.levene(accuratezza_modelli_ncs[4],accuratezza_modelli_cs_cv[4])
...
for alt in alternative:
    [stats_knn, p_value_knn] = stats.ttest_ind(accuratezza_modelli_ncs[0],accuratezza_modelli_cs_cv[0], alternative = alt)
    [stats_svm, p_value_svm] = stats.ttest_ind(accuratezza_modelli_ncs[1],accuratezza_modelli_cs_cv[1], alternative = alt)
    [stats_rf, p_value_rf] = stats.ttest_ind(accuratezza_modelli_ncs[2],accuratezza_modelli_cs_cv[2], alternative = alt)
    [stats_ab, p_value_ab] = stats.ttest_ind(accuratezza_modelli_ncs[3],accuratezza_modelli_cs_cv[3], alternative = alt)
    [stats_mlp, p_value_mlp] = stats.ttest_ind(accuratezza_modelli_ncs[4],accuratezza_modelli_cs_cv[4], alternative = alt)
...
for i in range(5):
    [p_min, p_max] = intervalli_confidenza_acc(accuratezza_modelli_cs_cv[i])
    err_lower = np.mean(accuratezza_modelli_cs_cv[i]) - p_min
    err_upper = p_max - np.mean(accuratezza_modelli_cs_cv[i])
...
print('cvs',lista_int_conf_cvs_acc)
print('ncs',lista_int_conf_ncs_acc)
print('cv_cs',lista_int_conf_cv_cs_acc)
print('cs',lista_int_conf_cs_acc)



with open('f1_modelli_cv_mc.pkl', 'rb') as file:
    f1_modelli_cvs_mc = pickle.load(file)

f1_modelli_cvs = np.array(f1_modelli_cvs_mc)
f1_modelli_cvs = f1_modelli_cvs[0]



with open('f1_modelli_ncs_mc.pkl','rb') as file:
    f1_modelli_ncs_mc = pickle.load(file)

f1_model_ncs = np.array(f1_modelli_ncs_mc)
f1_model_ncs = f1_model_ncs[0]

with open('f1_modelli_ncs_mc1.pkl', 'rb') as file:
    f1_modelli_ncs_mc1 = pickle.load(file)

f1_model_ncs1 = np.array(f1_modelli_ncs_mc1)
f1_model_ncs1 = f1_model_ncs1[0]

f1_modelli_ncs = np.concatenate((f1_model_ncs, f1_model_ncs1),axis = 1)



with open('F1_modelli_cs_cv_mc.pkl','rb') as file:
    f1_modelli_cs_cv_mc = pickle.load(file)

f1_model_cs_cv = np.array(f1_modelli_cs_cv_mc)
f1_modelli_cs_cv = f1_model_cs_cv[0]



with open('f1_modelli_cs_mc.pkl', 'rb') as file:
    f1_modelli_cs_mc = pickle.load(file)

f1_modelli_cs = np.array(f1_modelli_cs_mc)
f1_modelli_cs = f1_modelli_cs[0]


print("ncs",np.mean(f1_modelli_ncs[0]),np.mean(f1_modelli_ncs[1]),np.mean(f1_modelli_ncs[2]),np.mean(f1_modelli_ncs[3]),np.mean(f1_modelli_ncs[4]))
print("cv",np.mean(f1_modelli_cvs[0]),np.mean(f1_modelli_cvs[1]),np.mean(f1_modelli_cvs[2]),np.mean(f1_modelli_cvs[3]),np.mean(f1_modelli_cvs[4]))
print("cs_cv",np.mean(f1_modelli_cs_cv[0]),np.mean(f1_modelli_cs_cv[1]),np.mean(f1_modelli_cs_cv[2]),np.mean(f1_modelli_cs_cv[3]),np.mean(f1_modelli_cs_cv[4]))
print("cs",np.mean(f1_modelli_cs[0]),np.mean(f1_modelli_cs[1]),np.mean(f1_modelli_cs[2]),np.mean(f1_modelli_cs[3]),np.mean(f1_modelli_cs[4]))
...
stats.probplot(f1_modelli_cs_cv[0], dist='norm', plot=axes[0])
axes[0].set_title('QQ-plot-CV-CS F1')
axes[0].set_ylabel('KNN')

stats.probplot(f1_modelli_cs_cv[1], dist='norm', plot=axes[1])
axes[1].set_ylabel('SVM')

stats.probplot(f1_modelli_cs_cv[2], dist='norm', plot=axes[2])
axes[2].set_ylabel('RF')

stats.probplot(f1_modelli_cs_cv[3], dist='norm', plot=axes[3])
axes[3].set_ylabel('AB')

stats.probplot(f1_modelli_cs_cv[4], dist='norm', plot=axes[4])
axes[4].set_ylabel('MLP')
...
axes[0].hist(f1_modelli_cs_cv[0], bins = 10)
axes[0].set_title('ISTOGRAMMA CV-CS F1')
axes[0].set_ylabel('KNN')

axes[1].hist(f1_modelli_cs_cv[1], bins = 10)
axes[1].set_ylabel('SVM')

axes[2].hist(f1_modelli_cs_cv[2], bins = 10)
axes[2].set_ylabel('RF')

axes[3].hist(f1_modelli_cs_cv[3], bins = 10)
axes[3].set_ylabel('AB')

axes[4].hist(f1_modelli_cs_cv[4], bins = 10)
axes[4].set_ylabel('MLP')
...
axes[0].boxplot(f1_modelli_cs_cv[0])
axes[0].set_title('BOXPLOT CV-CS F1')
axes[0].set_ylabel('KNN')

axes[1].boxplot(f1_modelli_cs_cv[1])
axes[1].set_ylabel('SVM')

axes[2].boxplot(f1_modelli_cs_cv[2])
axes[2].set_ylabel('RF')

axes[3].boxplot(f1_modelli_cs_cv[3])
axes[3].set_ylabel('AB')

axes[4].boxplot(f1_modelli_cs_cv[4])
axes[4].set_ylabel('MLP')
...
for i in range(5):
    ...
    d2 = {"F1_Score":f1_modelli_cs_cv[i]}
    descr1 = "Modello CV"
    descr2 = "Modello CS_CV"
...
for i in range(5):
    [dist_norm, p_value] = stats.kstest(f1_modelli_cs_cv[i], 'norm')
    if p_value < 0.05:
        print(f"rifiuto l'ipotesi nulla per {modelli[i]}",p_value)
    elif p_value > 0.05:
        print(f"accetto l'ipotesi per {modelli[i]}",p_value)
...
for i in range(5):
    [dist_norm, p_value] = stats.shapiro(f1_modelli_cs_cv[i])
    if p_value < 0.05:
        print(f"rifiuto l'ipotesi nulla per {modelli[i]}",p_value)
    elif p_value > 0.05:
        print(f"accetto l'ipotesi per {modelli[i]}",p_value)
...
for alt in alternative:
    [stats_knn, p_value_knn] = stats.mannwhitneyu(f1_modelli_cvs[0],f1_modelli_cs_cv[0],alternative=alt)
    [stats_svm, p_value_svm] = stats.mannwhitneyu(f1_modelli_cvs[1],f1_modelli_cs_cv[1],alternative=alt)
    [stats_rf, p_value_rf] = stats.mannwhitneyu(f1_modelli_cvs[2],f1_modelli_cs_cv[2],alternative=alt)
    [stats_ab, p_value_ab] = stats.mannwhitneyu(f1_modelli_cvs[3],f1_modelli_cs_cv[3],alternative=alt)
    [stats_mlp, p_value_mlp] = stats.mannwhitneyu(f1_modelli_cvs[4],f1_modelli_cs_cv[4],alternative=alt)
...
for alt in alternative:
    [stats_knn, p_value_knn] = stats.mannwhitneyu(f1_modelli_ncs[0],f1_modelli_cs_cv[0],alternative=alt)
    [stats_svm, p_value_svm] = stats.mannwhitneyu(f1_modelli_ncs[1],f1_modelli_cs_cv[1],alternative=alt)
    [stats_rf, p_value_rf] = stats.mannwhitneyu(f1_modelli_ncs[2],f1_modelli_cs_cv[2],alternative=alt)
    [stats_ab, p_value_ab] = stats.mannwhitneyu(f1_modelli_ncs[3],f1_modelli_cs_cv[3],alternative=alt)
    [stats_mlp, p_value_mlp] = stats.mannwhitneyu(f1_modelli_ncs[4],f1_modelli_cs_cv[4],alternative=alt)
...
for alt in alternative:
    [stats_knn, p_value_knn] = stats.ttest_ind(f1_modelli_ncs[0],f1_modelli_cvs[0], alternative=alt)
    [stats_svm, p_value_svm] = stats.ttest_ind(f1_modelli_ncs[1],f1_modelli_cvs[1], alternative=alt)
    [stats_rf, p_value_rf] = stats.ttest_ind(f1_modelli_ncs[2],f1_modelli_cvs[2], alternative=alt)
    [stats_ab, p_value_ab] = stats.ttest_ind(f1_modelli_ncs[3],f1_modelli_cvs[3], alternative=alt)
    [stats_mlp, p_value_mlp] = stats.ttest_ind(f1_modelli_ncs[4],f1_modelli_cvs[4], alternative = alt)
...
[stats_knn, p_value_knn] = stats.levene(f1_modelli_cvs[0],f1_modelli_cs_cv[0])
[stats_svm, p_value_svm] = stats.levene(f1_modelli_cvs[1],f1_modelli_cs_cv[1])
[stats_rf, p_value_rf] = stats.levene(f1_modelli_cvs[2],f1_modelli_cs_cv[2])
[stats_ab, p_value_ab] = stats.levene(f1_modelli_cvs[3],f1_modelli_cs_cv[3])
[stats_mlp, p_value_mlp] = stats.levene(f1_modelli_cvs[4],f1_modelli_cs_cv[4])
...
for alt in alternative:
    [stats_knn, p_value_knn] = stats.ttest_ind(f1_modelli_cvs[0],f1_modelli_cs_cv[0], alternative = alt)
    [stats_svm, p_value_svm] = stats.ttest_ind(f1_modelli_cvs[1],f1_modelli_cs_cv[1], alternative = alt)
    [stats_rf, p_value_rf] = stats.ttest_ind(f1_modelli_cvs[2],f1_modelli_cs_cv[2], alternative = alt)
    [stats_ab, p_value_ab] = stats.ttest_ind(f1_modelli_cvs[3],f1_modelli_cs_cv[3], alternative = alt)
    [stats_mlp, p_value_mlp] = stats.ttest_ind(f1_modelli_cvs[4],f1_modelli_cs_cv[4], alternative = alt)
...
[stats_svm, p_value_svm] = stats.levene(f1_modelli_ncs[1], f1_modelli_cs[1])
[stats_rf, p_value_rf] = stats.levene(f1_modelli_ncs[2], f1_modelli_cs[2])
[stats_ab, p_value_ab] = stats.levene(f1_modelli_ncs[3], f1_modelli_cs[3])
[stats_mlp, p_value_mlp] = stats.levene(f1_modelli_ncs[4], f1_modelli_cs[4])
...
for alt in alternative:
    ...
    [stats_svm, p_value_svm] = stats.ttest_ind(f1_modelli_ncs[1],f1_modelli_cs[1], alternative = alt)
    [stats_rf, p_value_rf] = stats.ttest_ind(f1_modelli_ncs[2],f1_modelli_cs[2], alternative = alt)
    [stats_ab, p_value_ab] = stats.ttest_ind(f1_modelli_ncs[3],f1_modelli_cs[3], alternative = alt)
    [stats_mlp, p_value_mlp] = stats.ttest_ind(f1_modelli_ncs[4],f1_modelli_cs[4], alternative = alt)
...
[stats_knn, p_value_knn] = stats.levene(f1_modelli_ncs[0], f1_modelli_cs_cv[0])
[stats_svm, p_value_svm] = stats.levene(f1_modelli_ncs[1], f1_modelli_cs_cv[1])
[stats_rf, p_value_rf] = stats.levene(f1_modelli_ncs[2], f1_modelli_cs_cv[2])
[stats_ab, p_value_ab] = stats.levene(f1_modelli_ncs[3], f1_modelli_cs_cv[3])
[stats_mlp, p_value_mlp] = stats.levene(f1_modelli_ncs[4], f1_modelli_cs_cv[4])
...
for alt in alternative:
    [stats_knn, p_value_knn] = stats.ttest_ind(f1_modelli_ncs[0],f1_modelli_cs_cv[0], alternative = alt)
    [stats_svm, p_value_svm] = stats.ttest_ind(f1_modelli_ncs[1],f1_modelli_cs_cv[1], alternative = alt)
    [stats_rf, p_value_rf] = stats.ttest_ind(f1_modelli_ncs[2],f1_modelli_cs_cv[2], alternative = alt)
    [stats_ab, p_value_ab] = stats.ttest_ind(f1_modelli_ncs[3],f1_modelli_cs_cv[3], alternative = alt)
    [stats_mlp, p_value_mlp] = stats.ttest_ind(f1_modelli_ncs[4],f1_modelli_cs_cv[4], alternative = alt)
...
for i in range(5):
    [p_min, p_max] = intervalli_confidenza_f1(f1_modelli_cs_cv[i])
    err_lower = np.mean(f1_modelli_cs_cv[i]) - p_min
    err_upper = p_max - np.mean(f1_modelli_cs_cv[i])
...
print('cvs',lista_int_conf_cvs_f1)
print('ncs',lista_int_conf_ncs_f1)
print('cv_cs',lista_int_conf_cv_cs_f1)
print('cs',lista_int_conf_cs_f1)
...
for i in range(5):
    value1 = np.mean(accuratezza_modelli_cs_cv[i])
    value2 = np.mean(f1_modelli_cs_cv[i])
    value = [value1, value2]
