...
with open('accuratezza_conv1d_cvs.pkl', 'rb') as file:
    accuratezza_modello_cvs = pickle.load(file)

with open('accuratezza_conv1d_ncs.pkl', 'rb') as file:
    accuratezza_modello_ncs = pickle.load(file)

with open('accuratezza_conv1d_cv_cs.pkl', 'rb') as file:
    accuratezza_modello_cv_cs = pickle.load(file)

with open('accuratezza_conv1d_cs.pkl', 'rb') as file:
...
[stats_uguag, p_value] = stats.ttest_ind(accuratezza_modello_ncs,accuratezza_modello_cvs)
...
[stats_uguag, p_value] = stats.ttest_ind(accuratezza_modello_cvs,accuratezza_modello_cv_cs)
...
with open('f1_conv1d_cvs.pkl', 'rb') as file:
    f1_modello_cvs = pickle.load(file)

with open('f1_conv1d_ncs.pkl' ,'rb') as file:
    f1_modello_ncs = pickle.load(file)

with open('f1_conv1d_cv_cs.pkl' ,'rb') as file:
    f1_modello_cv_cs = pickle.load(file)

with open('f1_conv1d_cs.pkl' ,'rb') as file:
...
print(f"valore medio f1 cvs",f1_mean_cs)
...
with open('accuratezza_lstm_cvs.pkl', 'rb') as file:
    accuratezza_modello_cvs = pickle.load(file)

with open('accuratezza_lstm_ncs.pkl', 'rb') as file:
    accuratezza_modello_ncs = pickle.load(file)

with open('accuratezza_lstm_bi_cv_cs.pkl', 'rb') as file:
    accuratezza_modello_cv_cs = pickle.load(file)

with open('accuratezza_lstm_bi_cs.pkl', 'rb') as file:
    accuratezza_modello_cs = pickle.load(file)

media_acc_lstm_ncs = np.mean(accuratezza_modello_ncs)
media_acc_lstm_cvs = np.mean(accuratezza_modello_cvs)
media_acc_lstm_cv_cs = np.mean(accuratezza_modello_cv_cs)
media_acc_lstm_cs = np.mean(accuratezza_modello_cs)

print(f"acc_ncs",media_acc_lstm_ncs)
print(f"acc_cvs",media_acc_lstm_cvs)
print(f"acc_cv_cs",media_acc_lstm_cv_cs)
print(f"acc_cs",media_acc_lstm_cs)

fig, axes = plt.subplots(nrows=4, ncols=1, sharex=True)

stats.probplot(accuratezza_modello_ncs, dist='norm', plot=axes[0])
axes[0].set_title('QQ-PLOT ACCURATEZZA')
axes[0].set_ylabel('LSTM NCS')

stats.probplot(accuratezza_modello_cvs, dist='norm', plot=axes[1])
axes[1].set_ylabel('LSTM CVS')

stats.probplot(accuratezza_modello_cv_cs, dist='norm', plot=axes[2])
axes[2].set_ylabel('LSTM CV-CS')

stats.probplot(accuratezza_modello_cs, dist='norm', plot=axes[3])
axes[2].set_ylabel('LSTM CS')
...
axes[1].hist(accuratezza_modello_cvs, bins=10)
axes[1].set_ylabel('LSTM CV')

axes[2].hist(accuratezza_modello_cv_cs, bins=10)
axes[2].set_ylabel('LSTM CV-CS')

axes[3].hist(accuratezza_modello_cs, bins=10)
axes[3].set_ylabel('LSTM CS')
...
if p_value < 0.05:
    print(f"rifiuto l'ipotesi nulla per LSTM NCS", p_value)
elif p_value > 0.05:
    print(f"accetto l'ipotesi per LSTM NCS", p_value)

[dist_norm, p_value] = stats.kstest(accuratezza_modello_cvs, 'norm')

if p_value < 0.05:
    print(f"rifiuto l'ipotesi nulla per LSTM CVS", p_value)
elif p_value > 0.05:
    print(f"accetto l'ipotesi per LSTM CVS", p_value)

[dist_norm, p_value] = stats.kstest(accuratezza_modello_cv_cs, 'norm')

if p_value < 0.05:
    print(f"rifiuto l'ipotesi nulla per LSTM CV-CS", p_value)
elif p_value > 0.05:
    print(f"accetto l'ipotesi per LSTM CV-CS", p_value)

[dist_norm, p_value] = stats.kstest(accuratezza_modello_cs, 'norm')

if p_value < 0.05:
    print(f"rifiuto l'ipotesi nulla per LSTM CS", p_value)
elif p_value > 0.05:
    print(f"accetto l'ipotesi per LSTM CS", p_value)
...
[stats_ugual, p_value] = stats.ttest_ind(accuratezza_modello_ncs, accuratezza_modello_cvs)
...
def intervalli_confidenza_lstm2d_acc(accuratezza):
    alpha = 0.05
    index_low = (alpha / 2) * 100
    index_high = (1 - alpha / 2) * 100
    acc_ordin = np.sort(accuratezza)
...
[p_min, p_max] = intervalli_confidenza_lstm2d_acc(accuratezza_modello_ncs)
err_lower_ncs_acc = np.mean(accuratezza_modello_ncs) - p_min
err_upper_ncs_acc = p_max - np.mean(accuratezza_modello_ncs)
interval_conf_acc_ncs = [p_min, p_max]

[p_min, p_max] = intervalli_confidenza_lstm2d_acc(accuratezza_modello_cvs)
err_lower_cvs_acc = np.mean(accuratezza_modello_cvs) - p_min
err_upper_cvs_acc = p_max - np.mean(accuratezza_modello_cvs)
interval_conf_acc_cvs = [p_min, p_max]

[p_min, p_max] = intervalli_confidenza_lstm2d_acc(accuratezza_modello_cv_cs)
err_lower_cv_cs_acc = np.mean(accuratezza_modello_cv_cs) - p_min
err_upper_cv_cs_acc = p_max - np.mean(accuratezza_modello_cv_cs)
interval_conf_acc_cv_cs = [p_min, p_max]

[p_min, p_max] = intervalli_confidenza_lstm2d_acc(accuratezza_modello_cs)
err_lower_cs_acc = np.mean(accuratezza_modello_cs) - p_min
err_upper_cs_acc = p_max - np.mean(accuratezza_modello_cs)
interval_conf_acc_cs = [p_min, p_max]
...
with open('f1_lstm_cvs.pkl', 'rb') as file:
    f1_modello_cvs = pickle.load(file)

with open('f1_lstm_ncs.pkl', 'rb') as file:
    f1_modello_ncs = pickle.load(file)

with open('f1_lstm_bi_cv_cs.pkl', 'rb') as file:
    f1_modello_cv_cs = pickle.load(file)

with open('f1_lstm_bi_cs.pkl', 'rb') as file:
    f1_modello_cs = pickle.load(file)

media_f1_lstm_ncs = np.mean(f1_modello_ncs)
media_f1_lstm_cvs = np.mean(f1_modello_cvs)
media_f1_lstm_cv_cs = np.mean(f1_modello_cv_cs)
media_f1_lstm_cs = np.mean(f1_modello_cs)

print(f"valore medio f1 ncs",media_f1_lstm_ncs)
print(f"valore medio f1 cvs",media_f1_lstm_cvs)
print(f"valore medio f1 cv-cs",media_f1_lstm_cv_cs)
print(f"valore medio f1 cs",media_f1_lstm_cs)
...
if p_value < 0.05:
    print(f"rifiuto l'ipotesi nulla per LSTM CV", p_value)
elif p_value > 0.05:
    print(f"accetto l'ipotesi per LSTM CV", p_value)
...
alpha = 0.05
for alt in alternative:
    [stats_ugual, p_value] = stats.mannwhitneyu(f1_modello_ncs, f1_modello_cvs, alternative=alt)
...
for alt in alternative:
    [stats_ugual, p_value] = stats.mannwhitneyu(f1_modello_cvs, f1_modello_cv_cs, alternative=alt)
...
for alt in alternative:
    [stats_ugual, p_value] = stats.mannwhitneyu(f1_modello_ncs, f1_modello_cs, alternative=alt)
...
[stats_ugual, p_value] = stats.ttest_ind(f1_modello_ncs, f1_modello_cvs)
...
def intervalli_confidenza_lstm2d_f1(f1):
    alpha = 0.05
    index_low = (alpha / 2) * 100
    index_high = (1 - alpha / 2) * 100
    f1_ordin = np.sort(f1)
...
[p_min, p_max] = intervalli_confidenza_lstm2d_f1(f1_modello_ncs)
err_lower_ncs_f1 = np.mean(f1_modello_ncs) - p_min
err_upper_ncs_f1 = p_max - np.mean(f1_modello_ncs)
interval_conf_f1_ncs = [p_min, p_max]

[p_min, p_max] = intervalli_confidenza_lstm2d_f1(f1_modello_cvs)
err_lower_cvs_f1 = np.mean(f1_modello_cvs) - p_min
err_upper_cvs_f1 = p_max - np.mean(f1_modello_cvs)
interval_conf_f1_cvs = [p_min, p_max]

[p_min, p_max] = intervalli_confidenza_lstm2d_f1(f1_modello_cv_cs)
err_lower_cv_cs_f1 = np.mean(f1_modello_cv_cs) - p_min
err_upper_cv_cs_f1 = p_max - np.mean(f1_modello_cv_cs)
interval_conf_f1_cv_cs = [p_min, p_max]

[p_min, p_max] = intervalli_confidenza_lstm2d_f1(f1_modello_cs)
err_lower_cs_f1 = np.mean(f1_modello_cs) - p_min
err_upper_cs_f1 = p_max - np.mean(f1_modello_cs)
interval_conf_f1_cs = [p_min, p_max]
...
ax.set_xlabel('Metric Type')
ax.set_ylabel('Value con 95% CI')
ax.set_title('Statistica del LSTM')
ax.set_xticks(x)
ax.legend(loc = 'upper center')
ax.set_xticklabels(metrica)
...
with open('accuratezza_lstm_unid_cvs.pkl', 'rb') as file:
    accuratezza_modello_cvs = pickle.load(file)

with open('accuratezza_lstm_unid_ncs.pkl', 'rb') as file:
    accuratezza_modello_ncs = pickle.load(file)

with open('accuratezza_lstm_cv_cs.pkl', 'rb') as file:
    accuratezza_modello_cv_cs = pickle.load(file)

with open('accuratezza_lstm_uni_cs.pkl', 'rb') as file:
    accuratezza_modello_cs = pickle.load(file)
...
def intervalli_confidenza_lstm1d_acc(accuratezza):
    alpha = 0.05
    index_low = (alpha / 2) * 100
    index_high = (1 - alpha / 2) * 100
    acc_ordin = np.sort(accuratezza)
...
[p_min, p_max] = intervalli_confidenza_lstm1d_acc(accuratezza_modello_ncs)
err_lower_ncs_acc = np.mean(accuratezza_modello_ncs) - p_min
err_upper_ncs_acc = p_max - np.mean(accuratezza_modello_ncs)
interval_conf_acc_ncs = [p_min, p_max]

[p_min, p_max] = intervalli_confidenza_lstm1d_acc(accuratezza_modello_cvs)
err_lower_cvs_acc = np.mean(accuratezza_modello_cvs) - p_min
err_upper_cvs_acc = p_max - np.mean(accuratezza_modello_cvs)
interval_conf_acc_cvs = [p_min, p_max]

[p_min, p_max] = intervalli_confidenza_lstm1d_acc(accuratezza_modello_cv_cs)
err_lower_cv_cs_acc = np.mean(accuratezza_modello_cv_cs) - p_min
err_upper_cv_cs_acc = p_max - np.mean(accuratezza_modello_cv_cs)
interval_conf_acc_cv_cs = [p_min, p_max]

[p_min, p_max] = intervalli_confidenza_lstm1d_acc(accuratezza_modello_cs)
err_lower_cs_acc = np.mean(accuratezza_modello_cs) - p_min
err_upper_cs_acc = p_max - np.mean(accuratezza_modello_cs)
interval_conf_acc_cs = [p_min, p_max]
...
with open('f1_lstm_unid_cvs.pkl', 'rb') as file:
    f1_modello_cvs = pickle.load(file)

with open('f1_lstm_unid_ncs.pkl', 'rb') as file:
    f1_modello_ncs = pickle.load(file)

with open('f1_lstm_cv_cs.pkl', 'rb') as file:
    f1_modello_cv_cs = pickle.load(file)

with open('f1_lstm_uni_cs.pkl', 'rb') as file:
    f1_modello_cs = pickle.load(file)
...
print(f"valore medio f1 ncs",media_f1_lstm_ncs)
print(f"valore medio f1 cvs",media_f1_lstm_cvs)
print(f"valore medio f1 cv_cs",media_f1_lstm_cv_cs)
print(f"valore medio f1 cs",media_f1_lstm_cs)
...
def intervalli_confidenza_lstm1d_f1(f1):
    alpha = 0.05
    index_low = (alpha / 2) * 100
    index_high = (1 - alpha / 2) * 100
    f1_ordin = np.sort(f1)
...
[p_min, p_max] = intervalli_confidenza_lstm1d_f1(f1_modello_ncs)
err_lower_ncs_f1 = np.mean(f1_modello_ncs) - p_min
err_upper_ncs_f1 = p_max - np.mean(f1_modello_ncs)
interval_conf_f1_ncs = [p_min, p_max]

[p_min, p_max] = intervalli_confidenza_lstm1d_f1(f1_modello_cvs)
err_lower_cvs_f1 = np.mean(f1_modello_cvs) - p_min
err_upper_cvs_f1 = p_max - np.mean(f1_modello_cvs)
interval_conf_f1_cvs = [p_min, p_max]

[p_min, p_max] = intervalli_confidenza_lstm1d_f1(f1_modello_cv_cs)
err_lower_cv_cs_f1 = np.mean(f1_modello_cv_cs) - p_min
err_upper_cv_cs_f1 = p_max - np.mean(f1_modello_cv_cs)
interval_conf_f1_cv_cs = [p_min, p_max]

[p_min, p_max] = intervalli_confidenza_lstm1d_f1(f1_modello_cs)
err_lower_cs_f1 = np.mean(f1_modello_cs) - p_min
err_upper_cs_f1 = p_max - np.mean(f1_modello_cs)
interval_conf_f1_cs = [p_min, p_max]
...
with open('accuratezza_conv2d_cvs.pkl', 'rb') as file:
    accuratezza_modello_cvs = pickle.load(file)

with open('accuratezza_conv2d_ncs.pkl' ,'rb') as file:
    accuratezza_modello_ncs = pickle.load(file)

with open('accuratezza_conv2d_cv_cs.pkl', 'rb') as file:
    accuratezza_modello_cv_cs = pickle.load(file)

with open('accuratezza_conv2d_cs.pkl', 'rb') as file:
    accuratezza_modello_cs = pickle.load(file)
...
with open('f1_conv2d_cvs.pkl', 'rb') as file:
    f1_modello_cvs = pickle.load(file)

with open('f1_conv2d_ncs.pkl' ,'rb') as file:
    f1_modello_ncs = pickle.load(file)

with open('f1_conv2d_cv_cs.pkl', 'rb') as file:
    f1_modello_cv_cs = pickle.load(file)

with open('f1_conv2d_cs.pkl', 'rb') as file:
    f1_modello_cs = pickle.load(file)
...
print(f"valore medio f1 cvs",f1_mean_cvs)
print(f"valore medio f1 ncs",f1_mean_ncs)
print(f"valore medio f1 cvs",f1_mean_cv_cs)
...
with open('accuratezza_conv2dlstm_uni_cvs.pkl', 'rb') as file:
    accuratezza_modello_cvs = pickle.load(file)

with open('accuratezza_conv2dlstm_uni_ncs.pikle', 'rb') as file:
    accuratezza_modello_ncs = pickle.load(file)

with open('accuratezza_conv2dlstm_cv_cs.pkl', 'rb') as file:
    accuratezza_modello_cv_cs = pickle.load(file)

with open('accuratezza_conv2dlstm_cs.pkl', 'rb') as file:
    accuratezza_modello_cs = pickle.load(file)
...
stats.probplot(accuratezza_modello_cv_cs, dist='norm', plot=axes[3])
...
axes[2].hist(accuratezza_modello_cv_cs, bins = 10)
axes[2].set_ylabel('CONV2DLSTM CS-CV')
...
with open('f1_conv2dlstm_uni_cvs.pkl', 'rb') as file:
    f1_modello_cvs = pickle.load(file)

with open('f1_conv2dlstm_uni_ncs.pikle', 'rb') as file:
    f1_modello_ncs = pickle.load(file)

with open('f1_conv2dlstm_cv_cs.pkl', 'rb') as file:
    f1_modello_cv_cs = pickle.load(file)

with open('f1_conv2dlstm_cs.pkl', 'rb') as file:
    f1_modello_cs = pickle.load(file)
...
with open('accuratezza_conv1dlstmuni_cvs.pikle', 'rb') as file:
    accuratezza_modello_cvs = pickle.load(file)

with open('accuratezza_conv1dlstm_uni_ncs.pikle' ,'rb') as file:
    accuratezza_modello_ncs = pickle.load(file)

with open('accuratezza_conv1dlstm_cv_cs.pkl' ,'rb') as file:
    accuratezza_modello_cv_cs = pickle.load(file)

with open('Studio_Binario/accuratezza_conv1dlstm_cs.pkl', 'rb') as file:
    accuratezza_modello_cs = pickle.load(file)
...
with open('f1_conv1dlstm_uni_cvs.pikle', 'rb') as file:
    f1_modello_cvs = pickle.load(file)

with open('f1_conv1dlstm_uni_ncs.pikle' ,'rb') as file:
    f1_modello_ncs = pickle.load(file)

with open('f1_conv1dlstm_cv_cs.pkl', 'rb') as file:
    f1_modello_cv_cs = pickle.load(file)

with open('f1_conv1dlstm_cs.pkl', 'rb') as file:
    f1_modello_cs = pickle.load(file)
...
axes[2].hist(f1_modello_cvs, bins = 10)
axes[2].set_ylabel('CONV1DLSTM CV-CS')
