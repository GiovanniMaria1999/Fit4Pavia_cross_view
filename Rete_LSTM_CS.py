...
with open(os.path.join(cartella,'accuratezza_bilstm_cs_test.pkl'), 'wb') as file:
    pickle.dump(lista_acc_test,file)

with open(os.path.join(cartella, 'accuratezza_bilstm_cs_train.pkl'), 'wb') as file:
    pickle.dump(lista_acc_train, file)

with open(os.path.join(cartella,'f1_bilstm_cs_test.pkl'), 'wb') as file:
    pickle.dump(lista_f1_test,file)

with open(os.path.join(cartella,'f1_bilstm_cs_train.pkl'), 'wb') as file:
    pickle.dump(lista_f1_train, file)

with open(os.path.join(cartella,'confmatrix_bilstm_cs.pkl'), 'wb') as file:
    pickle.dump(conf_matrix_lstm, file)

with open(os.path.join(cartella,'bilstm_simul_id_cs.pkl'), 'wb') as file:
    pickle.dump(array_simul_id,file)

with open(os.path.join(cartella,'bilstm_array_dim_train_cs.pkl'), 'wb') as file:
    pickle.dump(array_dim_train_id,file)

with open(os.path.join(cartella,'bilstm_array_dim_test_cs.pkl'), 'wb') as file:
    pickle.dump(array_dim_test_id,file)


with open(os.path.join(cartella,'bilstm_etichetta_is_cs.pkl'), 'wb') as file:
    pickle.dump(etichetta_is_tot, file)

with open(os.path.join(cartella,'bilstm_etichetta_is_crossview_cs.pkl'), 'wb') as file:
    pickle.dump(etichetta_is_cv_tot, file)

with open(os.path.join(cartella,'bilstm_etichetta_is_train_cs.pkl'), 'wb') as file:
    pickle.dump(etichetta_is_tot_train, file)

with open(os.path.join(cartella,'bilstm_etichetta_is_test_cs.pkl'), 'wb') as file:
    pickle.dump(etichetta_is_tot_test, file)


with open(os.path.join(cartella,'bilstm_lista_nomi_simulazione_cs.pkl'), 'wb') as file:
    pickle.dump(lista_nomi_sim,file)

with open(os.path.join(cartella,'bilstm_is_pred_cc_train_cs.pkl'), 'wb') as file:
    pickle.dump(is_pred_cc_train_tot,file)

with open(os.path.join(cartella,'bilstm_is_pred_cc_test_cs.pkl'), 'wb') as file:
    pickle.dump(is_pred_cc_test_tot,file)

with open(os.path.join(cartella,'bilstm_item_loss_test_cs.pkl'), 'wb') as file:
    pickle.dump(item_loss_test_tot,file)

with open(os.path.join(cartella,'bilstm_item_loss_train_cs.pkl'), 'wb') as file:
    pickle.dump(item_loss_train_tot,file)

with open(os.path.join(cartella,'bilstm_prob_conf_train_cs.pkl'), 'wb') as file:
    pickle.dump(lista_prob_pred_train,file)

with open(os.path.join(cartella,'bilstm_prob_conf_test_cs.pkl'), 'wb') as file:
    pickle.dump(lista_prob_pred_test,file)

with open(os.path.join(cartella,'bilstm_ytest_cs.pkl'), 'wb') as file:
    pickle.dump(ytest_tot,file)

with open(os.path.join(cartella,'bilstm_ytrain_cs.pkl'), 'wb') as file:
    pickle.dump(ytrain_tot,file)

with open("iperparametri_bilstm_cs.pkl","wb") as file:
    pickle.dump(iperparametri, file)

with open(os.path.join(cartella,'bilstm_pred_train_cs.pkl'), 'wb') as file:
    pickle.dump(lista_predizioni_train,file)

with open(os.path.join(cartella,'bilstm_pred_test_cs.pkl'), 'wb') as file:
