...
with open(os.path.join(cartella,'accuratezza_conv2dlstm_ncs_test.pkl'), 'wb') as file:
    pickle.dump(lista_acc_test,file)

with open(os.path.join(cartella, 'accuratezza_conv2dlstm_ncs_train.pkl'), 'wb') as file:
    pickle.dump(lista_acc_train, file)

with open(os.path.join(cartella,'f1_conv2dlstm_ncs_test.pkl'), 'wb') as file:
    pickle.dump(lista_f1_test,file)

with open(os.path.join(cartella,'f1_conv2dlstm_ncs_train.pkl'), 'wb') as file:
    pickle.dump(lista_f1_train, file)

with open(os.path.join(cartella,'confmatrix_conv2dlstm_ncs.pkl'), 'wb') as file:
    pickle.dump(conf_matrix, file)



with open(os.path.join(cartella,'conv2dlstm_simul_id_ncs.pkl'), 'wb') as file:
    pickle.dump(array_simul_id,file)


with open(os.path.join(cartella,'conv2dlstm_array_dim_train_ncs.pkl'), 'wb') as file:
    pickle.dump(array_dim_train_id,file)

with open(os.path.join(cartella,'conv2dlstm_array_dim_test_ncs.pkl'), 'wb') as file:
    pickle.dump(array_dim_test_id,file)


with open(os.path.join(cartella,'conv2dlstm_etichetta_is_ncs.pkl'), 'wb') as file:
    pickle.dump(etichetta_is_tot, file)

with open(os.path.join(cartella,'conv2dlstm_etichetta_is_crossview_ncs.pkl'), 'wb') as file:
    pickle.dump(etichetta_is_cv_tot, file)

with open(os.path.join(cartella,'conv2dlstm_etichetta_is_train_ncs.pkl'), 'wb') as file:
    pickle.dump(etichetta_is_tot_train, file)

with open(os.path.join(cartella,'conv2dlstm_etichetta_is_test_ncs.pkl'), 'wb') as file:
    pickle.dump(etichetta_is_tot_test, file)


with open(os.path.join(cartella,'conv2dlstm_lista_nomi_simulazione_ncs.pkl'), 'wb') as file:
    pickle.dump(lista_nomi_sim,file)

with open(os.path.join(cartella,'conv2dlstm_is_pred_cc_train_ncs.pkl'), 'wb') as file:
    pickle.dump(is_pred_cc_train_tot,file)

with open(os.path.join(cartella,'conv2dlstm_is_pred_cc_test_ncs.pkl'), 'wb') as file:
    pickle.dump(is_pred_cc_test_tot,file)

with open(os.path.join(cartella,'conv2dlstm_item_loss_test_ncs.pkl'), 'wb') as file:
    pickle.dump(item_loss_test_tot,file)

with open(os.path.join(cartella,'conv2dlstm_item_loss_train_ncs.pkl'), 'wb') as file:
    pickle.dump(item_loss_train_tot,file)

with open(os.path.join(cartella,'conv2dlstm_prob_conf_train_ncs.pkl'), 'wb') as file:
    pickle.dump(lista_prob_pred_train,file)

with open(os.path.join(cartella,'conv2dlstm_prob_conf_test_ncs.pkl'), 'wb') as file:
    pickle.dump(lista_prob_pred_test,file)

with open(os.path.join(cartella,'conv2dlstm_ytest_ncs.pkl'), 'wb') as file:
    pickle.dump(ytest_tot,file)

with open(os.path.join(cartella,'conv2dlstm_ytrain_ncs.pkl'), 'wb') as file:
    pickle.dump(ytrain_tot,file)

with open("iperparametri_conv2dlstm_ncs.pkl","wb") as file:
    pickle.dump(iperparametri, file)

with open(os.path.join(cartella,'conv2dlstm_pred_train_ncs.pkl'), 'wb') as file:
    pickle.dump(lista_predizioni_train,file)

with open(os.path.join(cartella,'conv2dlstm_pred_test_ncs.pkl'), 'wb') as file:
