...
for i in range(100):
    ...
    f1_knn_test = f1_score(y_test, predizioni_knn_test, average = 'macro')
    f1_rf_test = f1_score(y_test, predizioni_rf_test, average = 'macro')
    f1_svm_test = f1_score(y_test, predizioni_svm_test, average = 'macro')
    f1_ab_test = f1_score(y_test, predizioni_ab_test, average = 'macro')
    f1_mlp_test = f1_score(y_test, predizioni_mlp_test, average = 'macro')
    ...
    f1_knn_train = f1_score(y_train, predizioni_knn_train, average = 'macro')
    f1_rf_train = f1_score(y_train, predizioni_rf_train, average = 'macro')
    f1_svm_train = f1_score(y_train, predizioni_svm_train, average = 'macro')
    f1_ab_train = f1_score(y_train, predizioni_ab_train, average = 'macro')
    f1_mlp_train = f1_score(y_train, predizioni_mlp_train, average = 'macro')
