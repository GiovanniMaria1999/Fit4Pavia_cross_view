...
# adesso costruisco la rete conv1dlstm
...
with open(os.path.join(cartella,'accuratezza_conv1dlstm_mc_ncs_test.pkl'), 'wb') as file:
    pickle.dump(lista_acc_test,file)

with open(os.path.join(cartella, 'accuratezza_conv1dlstm_mc_ncs_train.pkl'), 'wb') as file:
    pickle.dump(lista_acc_train, file)

with open(os.path.join(cartella,'f1_conv1dlstm_mc_ncs_test.pkl'), 'wb') as file:
    pickle.dump(lista_f1_test,file)

with open(os.path.join(cartella,'f1_conv1dlstm_mc_ncs_train.pkl'), 'wb') as file:
    pickle.dump(lista_f1_train, file)

with open(os.path.join(cartella,'confmatrix_conv1dlstm_mc_ncs.pkl'), 'wb') as file:
    pickle.dump(conf_matrix , file)

with open(os.path.join(cartella,'conv1dlstm_mc_simul_id_ncs.pkl'), 'wb') as file:
    pickle.dump(array_simul_id,file)

with open(os.path.join(cartella,'conv1dlstm_mc_array_dim_train_ncs.pkl'), 'wb') as file:
    pickle.dump(array_dim_train_id,file)

with open(os.path.join(cartella,'conv1dlstm_mc_array_dim_test_ncs.pkl'), 'wb') as file:
    pickle.dump(array_dim_test_id,file)

with open(os.path.join(cartella,'conv1dlstm_mc_etichetta_is_sub_ncs.pkl'), 'wb') as file:
    pickle.dump(etichetta_is_sub_tot, file)

with open(os.path.join(cartella,'conv1dlstm_mc_etichetta_is_sett_ncs.pkl'), 'wb') as file:
    pickle.dump(etichetta_is_sett_tot, file)

with open(os.path.join(cartella,'conv1dlstm_mc_etichetta_is_train_ncs.pkl'), 'wb') as file:
    pickle.dump(etichetta_is_tot_train, file)

with open(os.path.join(cartella,'conv1dlstm_mc_etichetta_is_test_ncs.pkl'), 'wb') as file:
    pickle.dump(etichetta_is_tot_test, file)

with open(os.path.join(cartella,'conv1dlstm_mc_lista_nomi_simulazione_ncs.pkl'), 'wb') as file:
    pickle.dump(lista_nomi_sim,file)

with open(os.path.join(cartella,'conv1dlstm_mc_is_pred_cc_train_ncs.pkl'), 'wb') as file:
    pickle.dump(is_pred_cc_train_tot,file)

with open(os.path.join(cartella,'conv1dlstm_mc_is_pred_cc_test_ncs.pkl'), 'wb') as file:
    pickle.dump(is_pred_cc_test_tot,file)

with open(os.path.join(cartella,'conv1dlstm_mc_item_loss_test_ncs.pkl'), 'wb') as file:
    pickle.dump(item_loss_test_tot,file)

with open(os.path.join(cartella,'conv1dlstm_mc_item_loss_train_ncs.pkl'), 'wb') as file:
    pickle.dump(item_loss_train_tot,file)

with open(os.path.join(cartella,'conv1dlstm_mc_prob_conf_train_ncs.pkl'), 'wb') as file:
    pickle.dump(lista_prob_pred_train,file)

with open(os.path.join(cartella,'conv1dlstm_mc_prob_conf_test_ncs.pkl'), 'wb') as file:
    pickle.dump(lista_prob_pred_test,file)

with open(os.path.join(cartella,'conv1dlstm_mc_ytest_ncs.pkl'), 'wb') as file:
    pickle.dump(ytest_tot,file)

with open(os.path.join(cartella,'conv1dlstm_mc_ytrain_ncs.pkl'), 'wb') as file:
    pickle.dump(ytrain_tot,file)

with open(os.path.join(cartella,"iperparametri_conv1dlstm_mc_ncs.pkl"),"wb") as file:
    pickle.dump(iperparametri, file)

with open(os.path.join(cartella,'conv1dlstm_mc_pred_test_ncs.pkl'), 'wb') as file:
    pickle.dump(lista_predizioni_test,file)

with open(os.path.join(cartella,"conv1dlstm_mc_pred_train_ncs.pkl"),"wb") as file:
