...
for i in range(len(sett_camera2)):
    print(f"Il {setting[i]} di CAM2 vista frontale viene effettuato:",sett_camera_vis_fro2[i])

[sett_camera_vis_fro3,idx] = camera_sett(camere[1],"R001",setting)
for i in range(len(sett_camera3)):
    print(f"Il {setting[i]} di CAM3 vista frontale viene effettuato:",sett_camera_vis_fro3[i])
...
for i in range(len(unique_paz)):
    ...
    print(f" Numero di ripetizioni R001 in classe A008 fatti dal {unique_paz[i]}:",paz_rip1)
    paziente_ripetizione1_8.append(paz_rip1)

for i in range(len(unique_paz)):
    paz_rip1 = paziente_ripetizione("R001", "A009", unique_paz[i])
    print(f" Numero di ripetizioni R001 in classe A009 fatti dal {unique_paz[i]}:", paz_rip1)
...
for i in range(len(unique_paz)):
    ...
    print(f" Numero di ripetizioni R002 in classe A008 fatti dal {unique_paz[i]}:",paz_rip1)
    paziente_ripetizione2_8.append(paz_rip1)

for i in range(len(unique_paz)):
    paz_rip1 = paziente_ripetizione("R002", "A009", unique_paz[i])
    print(f" Numero di ripetizioni R002 in classe A009 fatti dal {unique_paz[i]}:", paz_rip1)
...
# lunghezza sequenze setting per viste frontali

def lunghez_set_vf(set,ripetizione,camera):
...
lista_mean_lungh_set_vf2 = []
for set in setting:
    len_set = lunghez_set_vf(set,"R002","C002")
    print(f"lunghezza media sequenza {set} in vista frontale 2:",len_set)
    lista_mean_lungh_set_vf2.append(len_set)

lista_mean_lungh_set_vf3 = []
for set in setting:
    len_set = lunghez_set_vf(set, "R001", "C003")
    print(f"lunghezza media sequenza {set} in vista frontale 3:", len_set)
    lista_mean_lungh_set_vf3.append(len_set)


# lunghezza sequenze setting classe 8 e 9


def lunghez_set_classe(set,classe):
    lista = []
    for data in data_list:
        if set in data['file_name']:
            if classe in data['file_name']:
...
lista_mean_seq_set_clas8 = []
for set in setting:
    len_set = lunghez_set_classe(set,"A008")
    print(f"Lunghezza media sequnze del set {set} in classe 8:",len_set)
    lista_mean_seq_set_clas8.append(len_set)

lista_mean_seq_set_clas9 = []
for set in setting:
    len_set = lunghez_set_classe(set,"A009")
    print(f"Lunghezza media sequnze del set {set} in classe 9:",len_set)
    lista_mean_seq_set_clas9.append(len_set)


# frequenza setting in classe 8 e 9

def freq_setting_classe(set,classe):
...
freq_setting_classe8 = []
for set in setting:
    freq_set = freq_setting_classe(set,"A008")
    print(f"frequenza {set} in classe 8", freq_set)
    freq_setting_classe8.append(freq_set)

freq_setting_classe9 = []
for set in setting:
    freq_set = freq_setting_classe(set,"A009")
    print(f"frequenza {set} in classe 9", freq_set)
    freq_setting_classe9.append(freq_set)


# frequenza setting in vista frontale in classe 8 e 9


def freq_setting_classe_vf(set,classe,camera,ripetizione):
...
freq_setting_classe8_vf2 = []
for set in setting:
    freq_set_vf2_classe8 = freq_setting_classe_vf(set,"A008","C002","R002")
    print(f"frequenza {set} in classe 8 in vista frontale 2", freq_set_vf2_classe8)
    freq_setting_classe8_vf2.append(freq_set_vf2_classe8)

freq_setting_classe9_vf2 = []
for set in setting:
    freq_set_vf2_classe9 = freq_setting_classe_vf(set, "A009", "C002", "R002")
    print(f"frequenza {set} in classe 9 in vista frontale 2", freq_set_vf2_classe8)
    freq_setting_classe9_vf2.append(freq_set_vf2_classe9)

freq_setting_classe8_vf3 = []
for set in setting:
    freq_set_vf3_classe8 = freq_setting_classe_vf(set,"A008","C003","R001")
    print(f"frequenza {set} in classe 8 in vista frontale 3", freq_set_vf3_classe8)
    freq_setting_classe8_vf3.append(freq_set_vf3_classe8)

freq_setting_classe9_vf3 = []
for set in setting:
    freq_set_vf3_classe9 = freq_setting_classe_vf(set, "A009", "C003", "R001")
    print(f"frequenza {set} in classe 9 in vista frontale 3", freq_set_vf3_classe9)
    freq_setting_classe9_vf3.append(freq_set_vf3_classe9)


# sequenze temporali per setting per paziente

def seq_setting_paz(paziente):

    lista_lungh = []
    lista_lungh_mean_set = []
    for set in setting:
        for data in data_list:
            if paziente in data['file_name']:
                if set in data['file_name']:
                    lungh = len(data['skel_body0'])
                    lista_lungh.append(lungh)

        media_lungh_seq_set = np.mean(lista_lungh)
        lista_lungh_mean_set.append(media_lungh_seq_set)

    return lista_lungh_mean_set

lista_seq_set_paz = []

for paz in unique_paz:
    paz_set_seq = seq_setting_paz(paz)
    print(f"lunghezza media sequenze setting di {paz}", paz_set_seq)
    lista_seq_set_paz.append(paz_set_seq)
...
ax1.bar(keys_set,freq_setting_classe8)
ax1.set_title("Frequenze Setting in classe Sit Down e Stand Up")
ax1.set_ylabel('Sit Down')

ax2.bar(keys_set,freq_setting_classe9)
ax2.set_ylabel('Stand Up')
#plt.show()

# frequenza setting in classe 8 e 9 in vista fronatle 2 e 3

fig, (ax1, ax2) = plt.subplots(nrows = 2, ncols = 1, sharex = True)

ax1.bar(keys_set,freq_setting_classe8_vf2)
ax1.set_title("Frequenze Setting classe Sit Down e Stand Up in vista frontale 2")
ax1.set_ylabel('Classe 8 vist front 2')

ax2.bar(keys_set,freq_setting_classe9_vf2)
ax2.set_ylabel('Classe 9 vist front 2')
#plt.show()

fig, (ax1, ax2) = plt.subplots(nrows = 2, ncols = 1, sharex = True)

ax1.bar(keys_set,freq_setting_classe8_vf3)
ax1.set_title("Frequenze Setting classe Sit Down e Stand Up in vista frontale 3")
ax1.set_ylabel('Classe 8 vist front 3')

ax2.bar(keys_set,freq_setting_classe9_vf3)
ax2.set_ylabel('Classe 9 vist front 3')
#plt.show()

# lunghezza media sequenze setting in classe 8 e 9

fig, (ax1, ax2) = plt.subplots(nrows = 2, ncols = 1, sharex = True)

ax1.bar(keys_set,lista_mean_seq_set_clas8)
ax1.set_title("Lunghezza media sequenze per setting in classe Sit Down e Stand Up")
ax1.set_ylabel('Sit Down')

ax2.bar(keys_set,lista_mean_seq_set_clas9)
ax2.set_ylabel('Stand Up')
#plt.show()

# lunghezza media sequenze setting in vista frontale 2 e 3

fig, (ax1, ax2) = plt.subplots(nrows = 2, ncols = 1, sharex = True)

ax1.bar(keys_set,lista_mean_lungh_set_vf2)
ax1.set_title("Lunghezza media sequenze per setting in vista frontale 2 e 3 ")
ax1.set_ylabel('vista frontale 2')

ax2.bar(keys_set,lista_mean_lungh_set_vf3)
ax2.set_ylabel('vista frontale 3')
#plt.show()
